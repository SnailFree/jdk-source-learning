      ...
      synchronized (TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new StructMember (
            ...
            null);
          _tcOf_members0 = ORB.init ().create_string_tc (0);
          _tcOf_members0 = ORB.init ().create_alias_tc (org.omg.CORBA.RepositoryIdHelper.id (), "RepositoryId", _tcOf_members0);
          ...
          _members0[2] = new StructMember (
            ...
            null);
          _tcOf_members0 = ORB.init ().create_string_tc (0);
          _tcOf_members0 = ORB.init ().create_alias_tc (org.omg.CORBA.VersionSpecHelper.id (), "VersionSpec", _tcOf_members0);
